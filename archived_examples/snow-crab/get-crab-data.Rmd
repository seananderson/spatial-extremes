...
```{r}
if (!file.exists("examples/snow-crab/crab.csv")) {
...
Here's my quick attempts to plot log(number of individuals per trawl) with hexagon binning.

I'm assuming that each row of data represents a single trawl. But the following plot doesn't really resemble Fig. 5 in Swain and Wade (2002).
