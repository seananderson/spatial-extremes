...
#targetspp = "nauplii.Animalia.Arthropoda.Crustacea.Maxillopoda.Copepoda.Neocopepoda.Calanoida.N.A.N.A.Calanidae.Calanus.marshallae"
#d = d[,c("cruiseID","dateTime","stationID","consecStationNum","lat","lon","sonicDepth","towDepth","gear","ringDiam","meshSize","towType",targetspp)]
#names(d)[which(names(d)%in%c(targetspp))] = "density"

targetspp = "chloropyllA"
d = d[,c("cruiseID","dateTime","stationID","consecStationNum","lat","lon","sonicDepth","towDepth","gear","ringDiam","meshSize","towType",targetspp)]
names(d)[which(names(d)%in%c(targetspp))] = "density"
...
d = d[which(d$month%in%c(5) & d$year < 2007),]
```
