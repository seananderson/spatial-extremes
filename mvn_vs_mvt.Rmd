...
# fit the model
stanMod_gaussianPoisson = stan(file = 'stan_gaussianPoisson.stan',data = spatglm_data, verbose = TRUE, chains = 1, thin = 1, warmup = 5000, iter = 10000, pars = spatglm_pars, init = init_fun)
```
...
# fit the model
stanMod_mvtPoisson = stan(file = 'stan_mvtPoisson.stan',data = spatglm_data, verbose = TRUE, chains =1, thin = 1, warmup = 5000, iter = 10000, pars = spatglm_pars, init = init_fun)
```
...
# fit the model
stanMod_gaussianGamma = stan(file = 'gaussianGamma.stan',data = spatglm_data, verbose = TRUE, chains =1, thin = 1, warmup = 5000, iter = 10000, pars = spatglm_pars, init = init_fun)
```
...
# fit the model
stanMod_mvtGamma = stan(file = 'mvtGamma.stan',data = spatglm_data, verbose = TRUE, chains =1, thin = 1, warmup = 5000, iter = 10000, pars = spatglm_pars, init = init_fun)
```
