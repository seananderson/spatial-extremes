...
y.norm = rnorm(length(proj.norm), 3, sd= 0.1)  
...
# fit the model
stanMod_mvtGamma = stan(file = 'mvtGamma.stan',data = spatglm_data, 
  verbose = TRUE, chains = 4, thin = 1, warmup = 500, iter = 1000, 
  pars = spatglm_pars)
```
...
stanMod_mvtGamma = stan(file = 'mvtGamma_0616.stan',data = spatglm_data, 
  verbose = TRUE, chains = 4, thin = 1, warmup = 2000, iter = 4000, 
  pars = spatglm_pars)

extract(stanMod_mvtGamma, permuted = TRUE)
