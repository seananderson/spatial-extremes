...
mvt_gamma = rrfield(sum ~ as.factor(year) - 1, 
  data = d, 
  time = "year", lon = "Longitude", lat = "Latitude",
  nknots = 30,
  obs_error = "gamma", 
...
mvn_gamma = rrfield(sum ~ as.factor(year), data=d, time = "year",
  lon="Longitude", lat="Latitude", nknots = 30, obs_error = "gamma", covariance="squared-exponential",prior_gp_sigma = half_t(100, 0, 0.1), prior_gp_scale = half_t(100, 0, 0.05), prior_intercept = student_t(100, 3.5, 0.3), prior_beta = student_t(100, 0, 1), prior_sigma = half_t(10, 0, 0.5), 
