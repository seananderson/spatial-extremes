...
spatglm_data = list("nKnots"=nKnots, "nLocs"=nLocs, "nT" = length(unique(yearID)), "N" = length(Y), "stationID" = stationID, "yearID" = yearID, "y" = Y, "distKnotsSq" = distKnotsSq, "distKnots21Sq" = distKnots21Sq, "cov"=cov)
spatglm_pars = c("scaledf","yearEffects", "CV", "gp_sigmaSq", "gp_scale")
...
stanMod_gamma = stan(file = 'stan_models/mvtGamma_estSigma_index_cov.stan',data = spatglm_data, 
