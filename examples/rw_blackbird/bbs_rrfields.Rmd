...
d = d[which(d$statenum%in%c(83) & d$year > 2010),] 
...
mvt_gamma2 = rrfield(sum ~ as.factor(year) - 1, 
  ...
  nknots = 30, 
  obs_error = "gamma", 
  prior_gp_sigma = half_t(100, 0, 0.1),  # <- this line changed
  prior_gp_scale = half_t(3, 0, 1), 
  prior_intercept = student_t(100, 0, 10), 
  prior_beta = student_t(100, 0, 10), 
  prior_sigma = half_t(3, 0, 1), 
