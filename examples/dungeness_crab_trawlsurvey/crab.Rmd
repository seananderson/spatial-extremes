...
spatglm_data = list("nKnots"=nKnots, "nLocs"=nLocs, "nT" = length(unique(yearID)), "N" = length(Y), "stationID" = stationID, "yearID" = yearID, "y" = Y, "distKnotsSq" = distKnotsSq, "distKnots21Sq" = distKnots21Sq, "x"=log(d$bottom_depth))
spatglm_pars = c("scaledf","yearEffects", "CV","B")
...
stanMod_gamma = stan(file = 'stan_models/mvtGamma_estSigma_index_cov_yr.stan',data = spatglm_data, 
verbose = TRUE, chains = 3, thin = 1, warmup = 1000, iter = 2000, pars = spatglm_pars)

save.image("examples/crabs.Rdata")
