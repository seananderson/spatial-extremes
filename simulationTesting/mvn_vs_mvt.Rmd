...
# fit the model
stanMod_mvnNormal_1 = stan(file = 'simulationTesting/mvnNormal.stan',data = spatglm_data, 
...
# fit the model
stanMod_mvtNormal_1 = stan(file = 'simulationTesting/mvtNormal.stan',data = spatglm_data, 
  verbose = TRUE, chains = 3, thin = 1, warmup = 300, iter = 600, 
  pars = spatglm_pars)
...
# fit the model
stanMod_mvtGamma_1 = stan(file = 'simulationTesting/mvtGamma.stan',data = spatglm_data, 
  verbose = TRUE, chains = 3, thin = 1, warmup = 300, iter = 600, 
  pars = spatglm_pars)
...
Apply both models to the same simulated data set with the same random seed (30 knots, 100 data points, CV = 0.15).  
...
spatglm_data = list("nKnots"=nrow(dataSim$knots), "nLocs"=nLocs, "N"=nLocs, "nT" = 1, "y" = y.gamma, "location" = seq(1, nLocs), "distKnotsSq" = dataSim$distKnotsSq, "distKnots21Sq" = dataSim$distKnots21Sq)
# parameters to monitor
spatglm_pars = c("spatialEffectsKnots")

# fit the model
stanMod_mvtGamma_2 = stan(file = 'simulationTesting/mvtGamma.stan',data = spatglm_data, 
  verbose = TRUE, chains = 3, thin = 1, warmup = 300, iter = 600, 
  pars = spatglm_pars)
...
# fit the model
stanMod_mvtNorm_2 = stan(file = 'simulationTesting/mvtNormal.stan',data = spatglm_data, 
  verbose = TRUE, chains = 3, thin = 1, warmup = 300, iter = 600, 
  pars = spatglm_pars)
...
```{r stan_mvtGamma, cache=TRUE, eval=FALSE}
# Named list of data
