...
our model, as in any GLM, is a function of the mean via a
...
Most commonly, random fields are represented by 
...
tested CVs of 0.1, 0.6, and 1.2 representing minimal, moderate, ands
...
computations. We set the degrees of freedom parameter $\nu$ to 2.5 and used a
...
and the data, $y_{s,t}$, to be generated by a lognormal observation model
...
(LOOIC), a Bayesian information criteria that approximates 
leave-one-out performance \citep{vehtari2016},
