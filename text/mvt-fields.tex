...
Fig.~\ref{fig:sim-performance}a). The out-of-sample RMSE was slightly higher for the
...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption{Simulation testing the ability to recapture the
      degree of spatial heavy tailedness in a MVT random fields model.
