...
\begin{figure}[htb]
  \begin{center}
    ...
    \caption{Simulation testing the MVT random fields model.
      ...
      example model fit of a mismatched MVN model (white)
      and a correct MVT model (grey) (red dots show the true values).
...
\begin{figure}[htb]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{../figs/beetle-performance.pdf}
    \caption{
  ...
  \begin{table}
    ...
    \begin{scriptsize}
      \begin{tabular}{llllL{2cm}lL{2.5cm}lL{2.5cm}llL{2.5cm}}
        \toprule
        Package  & \thead[l]{MVT \\ random \\ fields} & \thead[l]{Formula          \\ interface} & Multivariate                                                     & Estimation & \thead[l]{Simulation                              \\ function} & \thead[l]{Observation \\ model}                                                      & \thead[l]{Maximum \\ likelihood \\ estimation} & \thead[l]{Covariance \\ functions} & \thead[l]{AR Spatial \\ Fields} & \thead[l]{Dynamic \\ Linear \\ Models} & URL \\
        \midrule
