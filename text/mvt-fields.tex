...
when data include extreme or ``black-swan'' events. \R{B7}Black-swan events refer to
...
\citep{roislien2007}.\R{A1}
% To our knowledge, MVT spatial fields
% have not been applied in ecology, fisheries, or environmental sciences.
...
$\mu_{s,t} \equiv \mathbb{E}(y_{s,t})$.\R{B13} We then define
...
on the random field estimation\R{B1} and therefore the predictions in space and
time.
