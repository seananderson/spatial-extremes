...
Let's instead fit a spatial GLM with random fields. (Note that we are only using 2 chains and 600 iterations here so the vignette builds quickly. For final inference, you should likely use 4 or more chains and more iterations.)
