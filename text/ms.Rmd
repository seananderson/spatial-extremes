...
model is easily implemented with our flexible new R package **rrfields**, which
uses an interface that should be familiar to anyone who has worked with
...
Second, we predict tree mortality from mountain pine beetle (*Dendroctonus
