...
A final step in our data simulation was to corrupt true data by including measurement or observation error. We assumed observations to be generated from a Gamma distribution, ${ Y }_{ it }\sim Gamma\left( a,\frac { a }{ E[{ Y }_{ it }] }  \right)$, where the Gamma shape parameter *a* can be reparameterized into the coefficient of variation (CV), $a=\frac { 1 }{ { CV }^{ 2 } }$.
